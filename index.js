...
function reportPanelEmbed() {
  return new EmbedBuilder()
    ...
    .setFooter({ text: 'Paradise State Roleplay • Anonymous reports can be created with /anonreport in a report ticket.' });
}
...
client.once('ready', async () => {
  ...
  try {
    await ensureSchema();
    await pollDuty();
    setInterval(pollDuty, DUTY_POLL_MS);
  } catch (error) {
    console.error('DATABASE / DUTY STARTUP ERROR:', error);
  }
});
