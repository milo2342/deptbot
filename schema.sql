...
CREATE TABLE IF NOT EXISTS `department_purchase_tickets` (
  `id` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
  `channelId` VARCHAR(50) NOT NULL,
  ...
  `assetsReady` TEXT NOT NULL,
  `highCommandReady` TEXT NOT NULL,
  `discordReady` TEXT NOT NULL,
  `documentsReady` TEXT NULL,
  `whyAllow` TEXT NOT NULL,
  `createdAt` INT(11) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uq_department_purchase_channel` (`channelId`),
  KEY `idx_department_purchase_applicant` (`applicantId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
